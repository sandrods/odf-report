...
const code = `report = ODFReport::Report.new("template.odt") do |r|
  r.add_field :company, "ACME Corp"
  r.add_field :date, Date.today

  r.add_table("ITEMS", items) do |t|
    t.add_column(:name)
    t.add_column(:price) { |i| currency(i.price) }
  end
end
...
const tabs = [
  { name: 'generate_report.rb', isActive: true },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Generate .odt documents by filling templates with your data.
                Fields, tables, sections, images — all from Ruby.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/docs/installation">Get started</Button>
                <Button href="https://github.com/sandrods/odf-report" variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
